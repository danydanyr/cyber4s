...
function kingPaintPossibleMovement(row, col){
...
function queenPaintPossibleMovement(row, col){
    //queen combines the movement of the rook and the bishop :o
    rookPaintPossibleMovement(row, col);
    bishopPaintPossibleMovement(row, col);
}
...
function onCellClick(e) {
    ...
    if(currentPiece.type === 'rook'){
        rookPaintPossibleMovement(selectedCell.parentNode.rowIndex, selectedCell.cellIndex,);
    }
        ...
        knightPaintPossibleMovement(selectedCell.parentNode.rowIndex, selectedCell.cellIndex);
    }
    else if(currentPiece.type === 'bishop'){
        bishopPaintPossibleMovement(selectedCell.parentNode.rowIndex, selectedCell.cellIndex);
    }
    else if(currentPiece.type === 'king'){
        kingPaintPossibleMovement(selectedCell.parentNode.rowIndex, selectedCell.cellIndex);
    }
    else if(currentPiece.type === 'queen'){
        queenPaintPossibleMovement(selectedCell.parentNode.rowIndex, selectedCell.cellIndex);
    }   
